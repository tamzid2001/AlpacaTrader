        ...
        >
          <div className="p-6">
            <div className="flex items-center space-x-2 mb-8">
              ...
              <span className="text-xl font-bold text-sidebar-foreground" data-testid="text-mobile-sidebar-title">
                PropFarming Pro
              </span>
            </div>
              ...
              <div className="mt-8 pt-4 border-t border-sidebar-border">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-sidebar-foreground truncate" data-testid="mobile-text-user-name">
                      {user.firstName || user.email?.split('@')[0] || 'User'}
                    </p>
                    <p className="text-xs text-sidebar-foreground/60 truncate" data-testid="mobile-text-user-email">
                      {user.email || ''}
                    </p>
                  </div>
                </div>
