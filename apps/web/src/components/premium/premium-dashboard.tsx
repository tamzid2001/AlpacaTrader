    ...
    <div className="space-y-6" data-testid="premium-dashboard">
      ...
      <div className="border-b">
        <nav className="flex space-x-8">
          ...
          >
            <EnhancedIcon name="BarChart3" size={16} className="mr-2 inline" />
            Overview
          </button>
          ...
          >
            <EnhancedIcon name="Briefcase" size={16} className="mr-2 inline" />
            Career Tools
          </button>
          ...
          <button
            ...
            data-testid="tab-mentorship"
          >
            <EnhancedIcon name="Users" size={16} className="mr-2 inline" />
            Mentorship
          </button>
          ...
          >
            <EnhancedIcon name="Zap" size={16} className="mr-2 inline" />
            Background Jobs
